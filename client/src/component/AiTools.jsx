    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                ...
                <p className='text-gray-500 max-w-1lg mx-auto'>Everything you need to
...
shadow-1g border border-gray-100 hover:-translate-y-1 transition-all
duration-3e0 cursor-pointer' onClick={()=> user && navigate(tool.path)} >
<tool.Icon className='w-12 h-12 p-3 text-white rounded-x1'  style=
{{background: `linear-gradient(to bottom, ${tool.bg.from}, ${tool.
bg.to})` }}/>
<h3 className='mt-6 mb-3 text-1lg font-semibold'>{tool.title}</h3>
