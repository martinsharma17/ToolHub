...
const Hero = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col items-center justify-center w-full bg-[url("/gradientBackground.png")] bg-cover bg-no-repeat min-h-screen'>

            <div className='text-center mb-6'>
                <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl  font-semibold mx-auto leading-[1.2]' >
                    Create Amazing Content <br /> with <span className='text-primary'>AI Tools </span></h1>

                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-x1 m-auto max-sm:text-xs text-grey-600'>
...
<img src={assets.user_group} alt="" className='h-8'/> Trusted by 1@k+ 
people
</div> 
