...
const Navbar = () => {
    ...
    return (
        <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between it py-3 px-4 sm:px-32 cursor-pointer'>
            <img src={assets.logo} className='w-32 sm:w-44' onClick={() => navigate('/')} />
